...
export const PublicPreviewLanding: React.FC = () => {
  ...
  const postAdmin = posts.find((p) => p.fijado || p.autor?.rol === 'Admin') || posts[0] || {
    ...
    titulo: comunidad.tituloBienvenida,
    contenido: comunidad.textoBienvenida,
    categoria: 'Empieza aquí',
    fecha: 'Reciente',
    autor: {
      nombre: comunidad.creador?.nombre || 'Administrador',
      avatar: comunidad.creador?.avatar || comunidad.logo,
    },
  };
  ...
  return (
    <div className="app-shell min-h-screen bg-[#f3f4f6] text-gray-900 flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span>{comunidad.llamadaAccion}</span>
            </button>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 flex-1">
        ...
        <div className="community-card overflow-hidden bg-white shadow-md border border-gray-200">
          ...
          <div className="relative h-52 sm:h-72 md:h-80 w-full overflow-hidden bg-slate-950">
            <img
              ...
              alt={comunidad.nombre}
              onError={(e) => {
                e.currentTarget.src = comunidad.logo;
              }}
          ...
          <div className="p-6 sm:p-8 space-y-5 text-center">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              >
                ...
                <span>{comunidad.llamadaAccion.toUpperCase()}</span>
              </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="community-card p-6 relative overflow-hidden bg-white shadow-xs">
              {/* Author row */}
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-gray-500 font-medium">
                      Regístrate para acceder a {comunidad.nombreAula}, descubrir contenido y participar en las conversaciones.
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="community-card p-6 bg-white space-y-3 shadow-xs">

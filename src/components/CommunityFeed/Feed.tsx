        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            <div className="flex-1 bg-slate-900/90 border border-slate-800 rounded-2xl px-4 py-2.5 text-sm text-slate-400 group-hover:border-slate-700 transition-all flex items-center justify-between">
              <span>¿Qué estás construyendo hoy, {usuarioActual.nombre.split(' ')[0]}?</span>
          ...
          <div className="space-y-6">
            {postsFiltrados.length === 0 ? (
              <div className="glass-panel rounded-3xl p-12 text-center border border-slate-800">
                <p className="text-sm text-slate-400">No se encontraron publicaciones en esta categoría.</p>
                <button
                  onClick={() => {
        ...
        <div className="space-y-6">
          <div className="glass-panel rounded-3xl p-6 border border-slate-800">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-4 flex items-center gap-2">
              <Users className="w-4 h-4 text-amber-400" /> Estadísticas de la Comunidad
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
                <div className="text-2xl font-black text-white">{comunidad.totalMiembros}</div>
                <div className="text-xs text-slate-400 mt-0.5">Miembros Totales</div>
              </div>
              <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
                ...
                <div className="text-xs text-slate-400 mt-0.5">Activos Hoy</div>
              </div>
            </div>
          </div>

          <div className="glass-panel rounded-3xl p-6 border border-amber-500/30 bg-gradient-to-b from-amber-500/5 to-transparent relative overflow-hidden">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <span className="w-8 h-8 rounded-xl bg-amber-500 text-slate-950 font-black text-sm flex items-center justify-center shadow-lg shadow-amber-500/20">
                  N{usuarioActual.nivel}
                </span>
                <div>
                  <h4 className="font-bold text-sm text-white">{nivelActualInfo.nombre}</h4>
                  <p className="text-xs text-amber-400 font-semibold">{usuarioActual.xp} Puntos XP</p>
                </div>
              </div>
          ...
          <div className="glass-panel rounded-3xl p-6 border border-slate-800 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
                <Trophy className="w-4 h-4 text-amber-400" /> Top Creadores del Mes
              </h3>
              <button
          ...
          {proximoEvento && (
            <div className="glass-panel rounded-3xl p-6 border border-slate-800 space-y-3">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
                  <CalendarIcon className="w-4 h-4 text-amber-400" /> Próximo Evento en Vivo
                </h3>
              </div>
